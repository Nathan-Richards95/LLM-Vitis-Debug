...
void mm3_kernel0_L3_B0_A0_C3(input_window_int8* __restrict matA,
        ...
        chess_loop_range(L3_bound_seq,)
    {
            ...
            chess_loop_range(L3_bound_oc,)
        {
            ...
            // K iteration 0
            acc0 = mac8(acc0, buf_matA0, 0, 0x0000, 8, 0x3120,
                        buf_matB0, 0, 0x8800, 2, 0x3210);
            ...
            acc1 = mac8(acc1, buf_matA0, 0, 0x0000, 8, 0x3120,
                        buf_matB1, 0, 0x8800, 2, 0x3210);
            ...
            // K iteration 1
            acc0 = mac8(acc0, buf_matA1, 0, 0x0000, 8, 0x3120,
                        buf_matB0, 0, 0x8800, 2, 0x3210);
            ...
            acc1 = mac8(acc1, buf_matA1, 0, 0x0000, 8, 0x3120,
                        buf_matB1, 0, 0x8800, 2, 0x3210);
            ...
            // BUG_INJECTED:
            // Removed output token write to create producer/consumer imbalance.
            // ORIGINAL:
